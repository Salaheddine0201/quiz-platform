...
- Interface moderne et responsive construite avec **React**, **Tailwind CSS v4** et **Shadcn UI**.
- Gestion des formulaires optimisée avec **React Hook Form** et **Zod** pour une validation robuste.
